...
function Signup() {
  ...
  return (
    ...
    >
      ...
      <div>
        <InputBox label='이름' placeholder='이름' engName='name' />
        ...
        <InputBox label='학번' placeholder='학번' engName='number' />
        <InputBox label='비밀번호' placeholder='비밀번호' type='password' engName='password' />
        <InputBox label='비밀번호 확인' placeholder='비밀번호 확인' type='password' engName='password' />
